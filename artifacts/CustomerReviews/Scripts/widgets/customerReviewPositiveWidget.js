angular.module('CustomerReviews')
    .controller('CustomerReviews.customerReviewPositiveWidgetController', ['$scope', 'CustomerReviews.api', 'platformWebApp.bladeNavigationService', function ($scope, reviewsApi, bladeNavigationService) {
        var blade = $scope.blade;
        var filter = { take: 0, minStars: 3 };
